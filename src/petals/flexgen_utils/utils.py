...
torch_type={ torch.float16,  torch.float32,  torch.uint8, torch.int8, torch.int32, torch.int64, torch.bool}
np_type={np.float16, np.float32,np.uint8, np.int8, np.int32, np.int64, bool}
